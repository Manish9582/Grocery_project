...
const Sancks = ({ snacks }) => {
    ...
    const [showCard, setshowCard] = useState(snacks.map(() => 0))
    ...
    const totalCards = snacks.length;
    const handlePrev = () => {
        ...
        <>
            {snacks.length >= 1 && (
                <div className='max-w-[1300px] mx-auto mt-5 md:px-4 sm:px-4 ss:px-4 s:px-4'>
                    <div className='my-3'>
                        <strong className='text-[26px]'>Snacks & Munchies</strong>
                    </div>
                    <div className='w-[100%] flex gap-4 lg:overflow-x-hidden overflow-hidden relative md:overflow-x-scroll  s:overflow-x-scroll  sm:overflow-x-scroll ss:overflow-x-scroll hide-scrollbar'>
                        {snacks.slice(currentIndex, currentIndex + 7).map((value, index) => {
                            return (
                                <div key={value.id}
