...
const adminSearch = ({ retrive, admin }) => {
    ...
    return (
        <>
            <LoginContext.Provider value={{ loginPage, setloginPage }}>
                ...
                <Header />
                <div className='max-w-[1300px] mx-auto border rounded-md my-12'>
                    ...
                    <div className='w-[100%]'>
                        <div className='grid grid-cols-12 py-2 items-center border-t border-b text-[18px] font-bold text-white bg-green-600'>
                            ...
                            <div className='col-span-1'>Price</div>
                            <div className='col-span-1'>Featur</div>
                        </div>
                        <div>
                            {retrive.data.map((data) => {
                                countSNummber++;
                                return (
                                    <div className='grid grid-cols-12 py-2 items-center  border-b'>
                    ...
                    <div className='flex justify-between items-center my-8 px-6'>
                        <div className='flex items-center gap-4'>
                            ...
                            <div>{retrive.total}</div>
                        </div>
                        <div className='flex gap-8'>
                            <Link href={retrive.prev_page_url} className='border p-2 text-[20px] rounded-sm bg-gray-100'>
                                <FaAngleLeft />
                            </Link>
                            <Link href={retrive.next_page_url} className='border p-2 text-[20px] rounded-sm bg-gray-100'>
                                <FaAngleRight />
                            </Link>
                        </div>
                    </div>
